...
(async () => {
    async function esperarUsuario() {
        ...
        let intentos = 0;
        // Espera un momento breve para asegurar que la sesión ha sido cargada desde sessionStorage
    ...
    // Páginas de Administración (gestionTurnos.html aplica por 'gestion')
    if (
    ...
    // Páginas de Reservas (si existiera un reservas.html aparte)
    if (
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    loginBtn.addEventListener("click", () => {
        ...
        if (cur) {
            ...
            if (currentPage.startsWith("admin") || currentPage.startsWith("abm-") || currentPage.startsWith("gestion")) {
                window.location.href = "index.html";
            }
        } else {
